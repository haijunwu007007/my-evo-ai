...
> 🏠 **个人全栈 AI 工作站** — 自托管 · 457 模块 · 463 文件 · 156 技能 · 101 集成 · 4 核心引擎 · 全量测试通过

> ⚠️ **Python 版本要求**: Python >=3.11（推荐 3.11 或 3.12）。不兼容 Python 3.10 及以下版本。

## 📸 截图

（截图待补充 — 运行 `http://localhost:8765/` 后即可看到完整界面）
...
- **可视化工作流**: http://127.0.0.1:8765/workflow
- **API 文档**: http://127.0.0.1:8765/scalar
