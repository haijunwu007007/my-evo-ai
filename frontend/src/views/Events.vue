<template>
  <div class="events-page">
    ...
    <el-card shadow="never" class="page-card" style="margin-top:16px">
      <template #header>
        <div class="card-header"><span>📋 事件规则</span><el-button size="small" type="primary" @click="showCreate=true">新建规则</el-button></div>
      </template>
      ...
      <el-empty v-else description="无事件规则" />
    </el-card>
