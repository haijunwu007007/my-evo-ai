...
function startVoiceRecord(e){
  ...
  try{
    ...
    }).catch(function(){b.classList.remove('recording');l.textContent='无权限';_voicing=false;_voiceReady=false;setTimeout(function(){l.textContent='🎤语音'},2000)})
  }catch(err){b.classList.remove('recording');l.textContent='不支持';_voicing=false;_voiceReady=false;setTimeout(function(){l.textContent='🎤语音'},2000)}
}
