"""
AUTO-EVO-AI V0.1 — Qodo Review API 路由
"""
import logging
...
router = APIRouter(prefix="/api/v1/qodo-review", tags=["qodo_review"])

try:
    from modules.qodo_review import QodoReviewModule
    _module = QodoReviewModule()
    _available = True
except Exception as e:
    _module = None
    _available = False
    logger.warning(f"Qodo Review 加载失败: {e}")
