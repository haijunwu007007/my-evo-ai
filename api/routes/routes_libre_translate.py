import logging
logger = logging.getLogger("evo.routes_libre_translate")
# coding: utf-8
from fastapi import APIRouter
from pydantic import BaseModel
router = APIRouter(prefix="/api/v1/libre-translate",tags=["libre_translate"])
try:
    from modules.libre_translate import module_class
    _m=module_class()
