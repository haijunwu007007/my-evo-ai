import logging
logger = logging.getLogger("evo.routes_vanna_ai_query")
# coding: utf-8
from fastapi import APIRouter
from pydantic import BaseModel
router = APIRouter(prefix="/api/v1/vanna-ai-query",tags=["vanna_ai_query"])
try:
    from modules.vanna_ai_query import module_class
    _m=module_class()
