...
__module_meta__ = {
    ...
    "inputs": [
        ...
        {"name": "cache", "type": "string", "required": True, "description": ""},
        {"name": "ttl_map", "type": "string", "required": True, "description": ""},
    ],
    "outputs": [
...
if __name__ == "__main__":
    m = RedisCacheModule()
    print(m.initialize())
    print(m.execute("set", {"key": "k1", "value": "hello", "ttl": 300, "tags": ["test"]}))
    print(m.execute("get", {"key": "k1"}))
    print(m.execute("incr", {"key": "counter"}))
    print(m.execute("hset", {"key": "user:1", "field": "name", "value": "alice"}))
    print(m.execute("hgetall", {"key": "user:1"}))
    print(m.execute("zadd", {"key": "rank", "members": {"alice": 100, "bob": 85}}))
    print(m.execute("lock_acquire", {"resource": "deploy", "owner": "ci"}))
